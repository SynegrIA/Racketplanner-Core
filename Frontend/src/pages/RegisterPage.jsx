                        ...
                        <div className="card-body p-4">
                            ...
                            {registroExitoso ? (
                                ...
                                <div className="text-center py-5">
                                    ...
                                    >
                                        <i className="bi bi-check-lg" style={{ fontSize: '4rem' }}></i>
                                    </div>
                                    <h3 className="mb-3 fw-bold">¡Registro completado con éxito!</h3>
                                    <p className="mb-4 fs-5 text-secondary">
                                        Se enviará un WhatsApp de confirmación al número:
                                    </p>
                                    <div className="mb-4 fs-4 fw-bold">
                                        +{codigoPais} {numero}
                                    </div>
                                    <p className="mb-5">
                                        Recibirás notificaciones de partidas disponibles según tus preferencias.
                                    </p>
                                    <button
                                        type="button"
